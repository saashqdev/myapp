---
title: Timeline
description: A flexible timeline component for displaying chronological events, processes, and workflows with support for different orientations, statuses, and custom content.
new: true
---
...
import {
  ...
  OrderTrackingTimelineExample,
  CompactTimelineExample,
  ExtendedHorizontalTimelineExample,
} from "@/components/ui/timeline";

A versatile timeline component perfect for displaying project workflows, order tracking, user activity, and any chronological sequence of events. Features smooth horizontal scrolling with ScrollArea integration for timeline overflow.
...
```tsx title="components/ui/timeline.tsx"
"use client";
...
```package-install
npx hextaui@latest add timeline
```
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function TimelineVariantsExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Task Completed",
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function HorizontalTimelineExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Planning",
...
### Extended Horizontal Timeline with ScrollArea

Perfect for displaying long processes or workflows with smooth horizontal scrolling.
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function ExtendedHorizontalTimelineExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Research",
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function TimelineWithCustomIconsExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Account Created",
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function TimelineWithContentExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Code Review Completed",
...
Perfect for project management and workflow visualization.
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function ProjectTimelineExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Project Kickoff",
...
Great for e-commerce order tracking and delivery status.
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function OrderTrackingTimelineExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Order Placed",
...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx
    function CompactTimelineExample() {
      const items: TimelineItem[] = [
        {
          id: "1",
          title: "Login",
...
<TypeTable
  type={{
    ...
    showConnectors: {
      description: "Whether to show connecting lines between items",
      type: "boolean",
      default: "true",
    },
    showTimestamps: {
      description: "Whether to show timestamps for items",
      type: "boolean",
      default: "true",
    },
    timestampPosition: {
      description: "Position of timestamps relative to content",
...
<TypeTable
  type={{
    ...
    status: {
      ...
      type: '"default" | "completed" | "active" | "pending" | "error"',
      default: '"default"',
    },
    icon: {
      description: "Custom icon to display (overrides status icon)",
      type: "React.ReactNode",
    },
    content: {
      description: "Custom content to display below the title and description",
      type: "React.ReactNode",
    },
    metadata: {
...
- **ScrollArea Integration**: Smooth horizontal scrolling for long timelines
- **Status System**: Built-in status indicators with appropriate icons and colors
- **Custom Icons**: Support for custom icons per timeline item
- **Flexible Content**: Rich content support with custom React components
- **Responsive Design**: Adapts to different screen sizes
- **Timestamp Formatting**: Automatic timestamp formatting with multiple position options
- **Connector Lines**: Visual connectors between timeline items
- **Accessibility**: Built with proper ARIA attributes and semantic markup
- **TypeScript**: Full TypeScript support with comprehensive type definitions

## Status Types

- **default**: Neutral state with gray styling
- **completed**: Finished items with green checkmark
- **active**: Currently active items with pulsing animation
- **pending**: Future items with muted styling
- **error**: Failed items with red error icon

## Use Cases

- **Project Management**: Visualize project phases and milestones
- **Order Tracking**: Show order status and delivery progress
- **User Activity**: Display user actions and system events
- **Process Workflows**: Illustrate step-by-step processes
- **Version History**: Show changes and updates over time
- **Event Logs**: Display chronological system or user events
